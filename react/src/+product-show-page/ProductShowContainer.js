...
import ProductCostTile from "./tiles/ProductCostTile";
import ProductSupplyTile from "./tiles/ProductSupplyTile";
import ProductLaborTile from "./tiles/ProductLaborTile";
import AddSupplyToProduct from "./supply-form/AddSupplyToProduct";
import SupplyFormContainer from "../shared/SupplyFormContainer";
import AddLaborToProduct from "./labor-form/AddLaborToProduct";
// import ProductCostTile from "./tiles/ProductCostTile";
...
class ProductShowContainer extends Component {
  ...
  render() {
    ...
    profitmargin = (
      ((product.retail_price - totalCostofProduction) / product.retail_price) *
      100
    ).toFixed(2);
